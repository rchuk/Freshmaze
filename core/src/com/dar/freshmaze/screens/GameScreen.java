...
public class GameScreen implements Screen {
    ...
    public GameScreen(FreshmazeGame game, OrthographicCamera camera, Viewport viewport, boolean skipMenu) {
        this.game = game;
    ...
    private void createUI() {
        ...
        healthIndicator.setBounds(0.0f, uiStage.getHeight() - 64.0f, 400.0f, 64.0f);
        ...
        attackIndicator.setBounds(0.0f, uiStage.getHeight() - 80.0f, 400.0f, 16.0f);
